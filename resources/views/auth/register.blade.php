    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow bg-light">
                <h2 class="card-header text-primary text-center shadow-sm display-4 rounded">{{ __('Register') }}</h2>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group mb-0">
                            <button type="submit" class="btn btn-primary btn-block p-2" dusk="register-btn">
                                {{ __('Register') }}
                            </button>
                        </div>
                    </form>
